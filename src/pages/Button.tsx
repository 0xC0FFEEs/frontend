...
const Button: Component = () => {
	return (
		<ul class={style.a}>
			<li class={style.a__item}>
				<input class={style.a__input + " " + style.b} type="radio" name="a-name" id="radio-1" value="" checked></input>
				<label class={style.a__label} for="radio-1">
					Monthly
				</label>
			</li>

			<li class={style.a__item}>
				<input class={style.a__input + " " + style.b} type="radio" name="a-name" id="radio-2" value=""></input>
				<label class={style.a__label} for="radio-2">
					Yearly
				</label>
				<div aria-hidden="true" class="a__marker"></div>
			</li>
		</ul>
	);
};
